var board = {
    ...
    // i think this just creates a reference
    qb: team0.roster[0],
    ...
    init: function(config) {
        ...
        this.tiles = this.DOMhandle.querySelectorAll('.board-tile');

        // extracting dom handling from player class, maybe unwisely
    ...
    reportReady: function() {
        return true;
        console.log("board init", this.ready);
    },
...
/////////////////////// end of board as object literal with config
